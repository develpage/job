 function initMap() {
     ...
     var map = new google.maps.Map(document.getElementById('map'), {
         center: { lat: 47.227337, lng: 39.705875 },
         zoom: 16,
         scrollwheel: true,
     ...
     var marker = new google.maps.Marker({
         position: { lat: 47.227337, lng: 39.705875 },
         map: map,
         icon: myMark,
     ...
     var InfoWindow = new google.maps.InfoWindow({
         content: '<b>Телеком Сервис</b><br>344010, г. Ростов-на-Дону<br>ул. Города Волос, д. 6, оф.610<br>'
     });
