...
// Inicialiaze scroll effect on window size ***************************************************************
    ...
    $(document).ready(function () {
        ...
        if ($(window).width() > 768) {
            ...
            new ScrollMagic.Scene({
                ...
                .on('enter', function (e) {
                    ...
                    if (e.scrollDirection === "FORWARD") {
                        ...
                        TweenMax.to($(window), 1, {
                            scrollTo: {
                                y: $('.short-services').offset().top - $(window).height(),
                                autoKill: true
                            },
                            ease: Power3.easeOut
                        })
                ...
                .on('enter', function (e) {
                    ...
                    if (e.scrollDirection === "FORWARD") {
                        ...
                        TweenMax.to($(window), 1.5, {
                            scrollTo: {
                                y: ($('.short-services').offset().top + $(window).height() * 1.45),
                                autoKill: true
                            },
                            ease: Power3.easeOut
                        })
            ...
            new ScrollMagic.Scene({
                    triggerElement: '.short-services',
                    offset: $('.short-services').height() * 1.95,
                    duration: 0,
                    triggerHook: 0.1
                })
                //.addIndicators()
            ...
            new ScrollMagic.Scene({
                ...
                .on('leave', function (e) {
                    if (e.scrollDirection === "FORWARD") {
                        ...
                        TweenMax.to($(window), 1, {
                            scrollTo: {
                                y: $('.short-services').offset().top - $(window).height() * 1.5,
                                autoKill: true
                            },
                            ease: Power3.easeOut
                        })
            ...
            new ScrollMagic.Scene({
                ...
                .on('leave', function (e) {
                    ...
                    if (e.scrollDirection === "FORWARD") {
                        ...
                        TweenMax.to($(window), 1, {
                            scrollTo: {
                                y: $('.short-services').offset().top + $(window).height() * 0.6,
                                autoKill: true
                            },
                            ease: Power3.easeOut
                        })
